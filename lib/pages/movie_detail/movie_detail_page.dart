...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  late Future<KeywordModel> keywords;
  ...
  fetchInitialData() {
    ...
    keywords = apiServices.getMoviesKeywords(widget.movieId);
    setState(() {});
  }
            ...
            if (snapshot.hasData) {
              ...
              return Column(
                children: [
                 ...
                 // FutureBuilder(future: keywords, 
                 // builder: (context, snapshot) {
                   // if (snapshot.hasData) {
                     //   final keywords = snapshot.data;

                       // return keywords!.keywords.isEmpty
                        //? const SidedBox(): Column( 
                         // crossAxisAlignment: CrossAxisAlignment.start,
                           //     children: [
                             //     const Text()
                               // ])
